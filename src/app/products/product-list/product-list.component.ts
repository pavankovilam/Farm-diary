...
export class ProductListComponent implements OnInit, AfterViewInit {
    ...
    manufacturers = [{ 'id': 'Ammul', 'checked': false },
    { 'id': 'Sangam', 'checked': false },
    { 'id': 'Heritage', 'checked': false },
    { 'id': 'Arogya', 'checked': false }
    ];
    os = [{ 'id': 'cow', 'checked': false },
    { 'id': 'Goat', 'checked': false },
    { 'id': 'Jersy', 'checked': false }];
    ...
    tabselect(producttype: string) {
        this.manufacturers = [{ 'id': 'Ammul', 'checked': false },
        { 'id': 'Sangam', 'checked': false },
        { 'id': 'Heritage', 'checked': false },
        { 'id': 'Arogya', 'checked': false }
        ];
        this.os = [{ 'id': 'cow', 'checked': false },
        { 'id': 'Goat', 'checked': false },
        { 'id': 'Jersy', 'checked': false }];
